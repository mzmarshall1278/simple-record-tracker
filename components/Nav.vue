<template>
    <div class="w-full bg-blue-900 py-2 px-12 font-normal">
        <nav class="flex justify-between">
            ...
            <div class="w-2/4 mx-auto flex justify-between">
                ...
                <div>
                    <button class="text-white my-auto h-full"><router-link class="hover:bg-white hover:text-blue-400 py-4 px-6 rounded-lg" to="/auth/login">login</router-link></button>
                </div>
            </div>
        </nav>
    </div>
